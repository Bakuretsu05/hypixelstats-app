  ...
  const infos = [
    {
      ...
      stats: [
        {
          text: "Level",
          value: getNetworkLevelbyNetworkExp(playerData.networkExp),
        },
        {
          text: "Karma",
        ...
        {
          text: "Friends",
          value: playerData.friends.length,
        },
      ],
    },
    {
      ...
      stats: [
        ...
        },
        {
          text: "First Login",
          value:
            getTimeGap(playerData.firstLogin, new Date().getTime()) + " ago",
        },
        {
          text: "Last Login",
          value:
            getTimeGap(playerData.lastLogin, new Date().getTime()) + " ago",
        },
      ],
    },
    {
